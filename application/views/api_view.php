...
<body>
    <div class="container">
        <br />
        <h3 align="center">CRUD API REST</h3>
        <br />
        ...
        <form method="post" id="user_form">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <span id="nombre_usuario_error" class="text-danger"></span>
                    <br />
...
$(document).ready(function(){
    ...
    $(document).on('submit', '#user_form', function(event){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                if(data.error)
                {
                    $('#nombre_usuario_error').html(data.first_name_error);
    ...
    $(document).on('click', '.edit', function(){
        ...
        $.ajax({
            ...
            {
                $('#userModal').modal('show');
                $('#nombre_usuario').val(data.first_name);
                $('#email').val(data.last_name);
    ...
    $(document).on('click', '.delete', function(){
        var user_id = $(this).attr('id');
        if(confirm("¿Segur@ que desea eliminar?"))
        {
            $.ajax({
                url:"<?php echo base_url(); ?>test_api/action",
                method:"POST",
